...
const getServiceIcon = (title: string) => {
  ...
  if (norm.includes('arquitectura')) return 'mdi:sitemap-outline'
  if (norm.includes('chatbots') || norm.includes('ia')) return 'mdi:robot-excited-outline'
  ...
  if (norm.includes('mentoría') || norm.includes('liderazgo')) return 'mdi:account-group-outline'
    ...
    <div class="max-w-6xl mx-auto relative z-10">
      ...
      <div class="mb-16">
        ...
        <p class="text-tech-gray mt-4 max-w-2xl text-sm sm:text-base">
          Diseño, desarrollo y escalamiento de soluciones tecnológicas orientadas a producción, alto rendimiento y crecimiento del negocio.
        </p>
      </div>
